...
<div class="container">
    ...
    <div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" class="active"><a href="#eliminar" aria-controls="profile" role="tab" data-toggle="tab">Eliminar</a></li>
            <li role="presentation"><a href="#editar" aria-controls="messages" role="tab" data-toggle="tab">Editar</a></li>
            <li role="presentation"><a href="#listar" aria-controls="settings" role="tab" data-toggle="tab">Listar</a></li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content">
            ...
            ?>
            <div role="tabpanel" class="tab-pane fade in active" id="eliminar">
                <div class="box">
                    <br>
                    <div class="alert alert-warning">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        <strong>Registro eliminado!</strong> El registro seleccionado ha sido eliminado con éxito de la base de datos.
                    </div>
